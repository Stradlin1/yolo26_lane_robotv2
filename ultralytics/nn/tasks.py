...
class LaneRobotModel(DetectionModel):
    """Fixed-task row-anchor lane model using a YOLO26 backbone and LaneRobot-compatible heads."""
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if m in {Detect, YOLOEDetect, Segment, Segment26, YOLOESegment, YOLOESegment26, Pose, Pose26, OBB, OBB26}:
                m.legacy = legacy
        elif m in {LaneRobot, LaneRobotV2, LaneRobotV2Independent}:
    ...
    if isinstance(model, torch.nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, (Segment, YOLOESegment)):
                ...
                return "obb"
            elif isinstance(m, (LaneRobot, LaneRobotV2, LaneRobotV2Independent)):
                return "lane"
